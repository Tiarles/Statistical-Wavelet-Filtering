...
def heavsineFunction(dim=1024, normalize=True):
    '''
...
def dopplerFunction(dim=1024, normalize=True):
    '''
...
def blockFunction(dim=1024, normalize=True):
    '''
...
def bumpFunction(dim=1024, normalize=True):
    '''
